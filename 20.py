...
KAC = [cl,k1,k2,k3,k4,k5,k6,k7,k8,k9,k10,k11,k12,k13,k14,k15,k16,k17,k18,k19,k20]
ABC = [cl,k1,k2,k3,k4,k5,k6,k7,k8,k9,k10,k11,k12,k13,k14,k15,k16,k17,k18,k19,k20]
Bots = [mid,mid1,mid2,mid3,mid4,mid5,mid6,mid7,mid8,mid9,mid10,mid11,mid12,mid13,mid14,mid15,mid16,mid17,mid18,mid19,mid20]
...
wait = {
    ...
    "sticker":False,  
    "selfbot":True,
    "mention":"ᗯᗩITIᑎG ᖴOᖇ ᗯIᖴI ᔕIᑎGᑎᗩᒪᔕ..",
    "Respontag":"𝒞𝑜𝓂𝑒 𝑜𝓃, 𝐼'𝓂 𝓅𝑒𝑒𝓀𝒾𝓃𝑔, 𝒟𝑒𝒶𝓇",
    "welcome":"Wellcome Dear",
    "comment":"Lover Boy is Here",
    "comment1":"Auto like By,mai",
    "message":"by,mai"
}
...
tz = pytz.timezone("Pakistan Standard Time")
...
def changeProfileVideo(to):
    if settings['changeProfileVideo']['picture'] == None:
        return cl.sendMessage(to, "Foto not ditemukan")
    elif settings['changeProfileVideo']['video'] == None:
        return cl.sendMessage(to, "Video not ditemukan")
    else:
...
def help():
    ...
    key = key.title()
    helpMessage = "╭━━━━━━━━━━━━━━━\n"
    helpMessage += "┃ " + "╭──⍟╔⪨⪩┅༐┅͜͡❇ℜ𝔞𝔰𝔠𝔞𝔩𝔰 𝔖𝔮𝔲𝔞𝔡║❇͜͡┅༐┅⪨⪩⍟─\n"
    helpMessage += "┃" + " ├───[Mai]──\n"
    helpMessage += "┃" + " ├──────────────\n"
    ...
    helpMessage += "┃ " + "╰──⍟╔⪨⪩┅༐┅͜͡❇ℜ𝔞𝔰𝔠𝔞𝔩𝔰 𝔖𝔮𝔲𝔞𝔡║❇͜͡┅༐┅⪨⪩⍟──\n"
    helpMessage += "╰━━━━━━━━━━━━━━━━"
    helpMessage += " Creator: ╔⪨⪩┅༐┅͜͡❇ŚhÀH•ŹÀ!η࿐❥║❇͜͡┅༐┅⪨⪩\n"
    return helpMessage
...
def helpbot():
    ...
    key = key.title()
    helpMessage2 = "╭━━━━━━━━━━━━━━━━\n"
    helpMessage2 += "┃ " + "╭───⍟╔⪨⪩┅༐┅͜͡❇ℜ𝔞𝔰𝔠𝔞𝔩𝔰 𝔖𝔮𝔲𝔞𝔡║❇͜͡┅༐┅⪨⪩⍟─\n"
    helpMessage2 += "┃" + " ├───[Mai]──\n"
    helpMessage2 += "┃" + " ├──────────────\n"
    helpMessage2 += "╠❂➣ %i. " % num + key + "K @\n"
    num = (num+1)
    helpMessage2 += "╠❂➣ %i. " % num + key + "V @ \n"
    num = (num+1)
    ...
    num = (num+1)
    helpMessage2 += "╠❂➣ %i. " % num + key + "url on/off\n"
    num = (num+1)
    ...
    num = (num+1)    
    helpMessage2 += "╠❂➣ %i. " % num + key + "in20「in」\n"
    num = (num+1)  
    helpMessage2 += "╠❂➣ %i. " % num + key + "out20「lv」\n"
    num = (num+1)    
    ...
    helpMessage2 += "┃ " + "╰──⍟╔⪨⪩┅༐┅͜͡❇ℜ𝔞𝔰𝔠𝔞𝔩𝔰 𝔖𝔮𝔲𝔞𝔡║❇͜͡┅༐┅⪨⪩⍟──\n"
    helpMessage2 += "╰━━━━━━━━━━━━━━━━"
    helpMessage2 += " My ID LINE : 〘 ╔⪨⪩┅༐┅͜͡❇ℜ𝔞𝔰𝔠𝔞𝔩𝔰 𝔖𝔮𝔲𝔞𝔡║❇͜͡┅༐┅⪨⪩〙\n"
    return helpMessage2
...
def helpbot1():
    ...
    key = key.title()
    helpMessage3 = "╭━━━━━━━━━━━━━━━━\n"
    helpMessage3 += "┃ " + "╭───⍟╔⪨⪩┅༐┅͜͡❇ℜ𝔞𝔰𝔠𝔞𝔩𝔰 𝔖𝔮𝔲𝔞𝔡║❇͜͡┅༐┅⪨⪩⍟─\n"
    helpMessage3 += "┃" + " ├───[Mai]──\n"
    helpMessage3 += "┃" + " ├──────────────\n"
    ...
    helpMessage3 += "┃ " + "╰──⍟╔⪨⪩┅༐┅͜͡❇ℜ𝔞𝔰𝔠𝔞𝔩𝔰 𝔖𝔮𝔲𝔞𝔡║❇͜͡┅༐┅⪨⪩⍟──\n"
    helpMessage3 += "╰━━━━━━━━━━━━━━━━"
    helpMessage3 += " My ID LINE : 〘 ╔⪨⪩┅༐┅͜͡❇ℜ𝔞𝔰𝔠𝔞𝔩𝔰 𝔖𝔮𝔲𝔞𝔡║❇͜͡┅༐┅⪨⪩ 〙\n"
    return helpMessage3
...
def helpbot2():
    ...
    key = key.title()
    helpMessage4 = "╭━━━━━━━━━━━━━━━━\n"
    helpMessage4 += "┃ " + "╭───⍟╔⪨⪩┅༐┅͜͡❇ℜ𝔞𝔰𝔠𝔞𝔩𝔰 𝔖𝔮𝔲𝔞𝔡║❇͜͡┅༐┅⪨⪩⍟─\n"
    helpMessage4 += "┃" + " ├───[Mai]──\n"
    helpMessage4 += "┃" + " ├──────────────\n"
    helpMessage4 += "╠❂➣ %i. " % num + key + "H\n"
    num = (num+1)
    helpMessage4 += "╠❂➣ %i. " % num + key + "hh\n"
    num = (num+1)
    helpMessage4 += "╠❂➣ %i. " % num + key + "hhh\n"
    num = (num+1)
    helpMessage4 += "╠❂➣ %i. " % num + key + "Hk\n"
    num = (num+1)
    helpMessage4 += "╠❂➣ %i. " % num + key + "Set\n"
    num = (num+1)
    helpMessage4 += "┃ " + "├──────────────\n"
    helpMessage4 += "┃ " + "╰──⍟╔⪨⪩┅༐┅͜͡❇ℜ𝔞𝔰𝔠𝔞𝔩𝔰 𝔖𝔮𝔲𝔞𝔡║❇͜͡┅༐┅⪨⪩⍟──\n"
    helpMessage4 += "╰━━━━━━━━━━━━━━━━"
    helpMessage4 += " My ID LINE : 〘 ╔⪨⪩┅༐┅͜͡❇ℜ𝔞𝔰𝔠𝔞𝔩𝔰 𝔖𝔮𝔲𝔞𝔡║❇͜͡┅༐┅⪨⪩ 〙\n"
    return helpMessage4
...
#====================================================================                            
        ...
        if op.type == 13:
            ...
            if mid17 in op.param3:
                if wait["autoJoin"] == True:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        k17.accptGroupInvitation(op.param1)
        ...
        if op.type == 19 or op.type == 32:
            if mid in op.param3:
                ...
                if op.param2 in staff:
                    ...
                    wait["blacklist"][op.param2] = True    
                    try:
                        k1.inviteIntoGroup(op.param1,[mid,mid1,mid2,mid3,mid4,mid5,mid6,mid7,mid8,mid9,mid10,mid11,mid12,mid13,mid14,mid15,mid16,mid17,mid18,mid19,mid20])
                        k1.kickoutFromGroup(op.param1,[op.param2])
                        cl.acceptGroupInvitation(op.param1)
                        k2.cancelGroupInvitation(op.param1,[op.param2])
                        wait["blacklist"][op.param2] = True
                        ...
                        try:
                            k2.inviteIntoGroup(op.param1,[mid,mid1,mid2,mid3,mid4,mid5,mid6,mid7,mid8,mid9,mid10,mid11,mid12,mid13,mid14,mid15,mid16,mid17,mid18,mid19,mid20])
                            k2.kickoutFromGroup(op.param1,[op.param2])
                            cl.acceptGroupInvitation(op.param1)
                            k3.cancelGroupInvitation(op.param1,[op.param2])
                            wait["blacklist"][op.param2] = True
                            ...
                            try:
                                k3.inviteIntoGroup(op.param1,[mid,mid1,mid2,mid3,mid4,mid5,mid6,mid7,mid8,mid9,mid10,mid11,mid12,mid13,mid14,mid15,mid16,mid17,mid18,mid19,mid20])
                                k3.kickoutFromGroup(op.param1,[op.param2])
                                cl.acceptGroupInvitation(op.param1)
                                ...
                                try:
                                    k4.inviteIntoGroup(op.param1,[mid,mid1,mid2,mid3,mid4,mid5,mid6,mid7,mid8,mid9,mid10,mid11,mid12,mid13,mid14,mid15,mid16,mid17,mid18,mid19,mid20])
                                    k4.kickoutFromGroup(op.param1,[op.param2])
                                    cl.acceptGroupInvitation(op.param1)
                                    ...
                                    try:
                                        k5.inviteIntoGroup(op.param1,[mid,mid1,mid2,mid3,mid4,mid5,mid6,mid7,mid8,mid9,mid10,mid11,mid12,mid13,mid14,mid15,mid16,mid17,mid18,mid19,mid20])
                                        k5.kickoutFromGroup(op.param1,[op.param2])
                                        cl.acceptGroupInvitation(op.param1)
                                        ...
                                        try:
                                            k6.inviteIntoGroup(op.param1,[mid,mid1,mid2,mid3,mid4,mid5,mid6,mid7,mid8,mid9,mid10,mid11,mid12,mid13,mid14,mid15,mid16,mid17,mid18,mid19,mid20])
                                            k6.kickoutFromGroup(op.param1,[op.param2])
                                            cl.acceptGroupInvitation(op.param1)
                                            ...
                                            try:
                                                k7.inviteIntoGroup(op.param1,[mid,mid1,mid2,mid3,mid4,mid5,mid6,mid7,mid8,mid9,mid10,mid11,mid12,mid13,mid14,mid15,mid16,mid17,mid18,mid19,mid20])
                                                k7.kickoutFromGroup(op.param1,[op.param2])
                                                cl.acceptGroupInvitation(op.param1)
                                                k8.cancelGroupInvitation(op.param1,[op.param2])
                                                wait["blacklist"][op.param2] = True
                                                ...
                                                try:
                                                    ...
                                                    try:
                                                        k10.inviteIntoGroup(op.param1,[mid,mid1,mid2,mid3,mid4,mid5,mid6,mid7,mid8,mid9,mid10,mid11,mid12,mid13,mid14,mid15,mid16,mid17,mid18,mid19,mid20])
                                                        k10.kickoutFromGroup(op.param1,[op.param2])
                                                        cl.acceptGroupInvitation(op.param1)
                ...
                if receiver in temp_flood:
                    if temp_flood[receiver]["expire"] == True:
                        if cmd == "open" and sender == mid:
                            ...
                            cl.sendMessage(to, "Bot kembali active")
                        return
                        ...
                        if temp_flood[receiver]["flood"] >= 20:
                            ...
                            ret_ = "Spam terdeteksi, Bot akan silent selama 30 detik pada ruangan ini atau ketik {}Open untuk activate kembali.".format(setKey)
                        ...
                        pass
                         ...
                         for target in targets:
                             try:
                                  ...
                                  zxc = ""
                                  zx2 = []
                                  xpesan =  " Success Invite \nNama "
                                  ret_ = "Ketik Invite off jika Already done"
                                  ry = str(ryan.displayName)
                                  pesan = ''
                                  pesan2 = pesan+"@x\n"
                                  xlen = str(len(zxc)+len(xpesan))
               ...
               if msg.contentType == 0:
                    ...
                    if text is None:
                        ...
                        if cmd == "on20":
                            if msg._from in owner or msg._from in admin or msg._from in staff:
                                wait["selfbot"] = True
                                cl.sendMessage(msg.to, "Bot has been di activekan")
...
#================BOT UPDATE NAME============#
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                dz.sendMessage(msg.to,"Nama replaced to " + string + "")
#===========BOT UPDATE============#                                                          
...
#====================================================================                            
                         ...
                         if msg._from in admin:
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               k1.sendMessage(msg.to, "۞❂✪₷ŚhÀH•ŹÀ!η❥₹ ⋮➲➤➤")
                               k2.sendMessage(msg.to, "۞❂✪₷ŚhÀH•ŹÀ!η❥₹ ⋮➲➤➤")
                               k3.sendMessage(msg.to, "۞❂✪₷ŚhÀH•ŹÀ!η❥₹ ⋮➲➤➤")
                               k4.sendMessage(msg.to, "۞❂✪₷ŚhÀH•ŹÀ!η❥₹ ⋮➲➤➤")
                               k5.sendMessage(msg.to, "۞❂✪₷ŚhÀH•ŹÀ!η❥₹ ⋮➲➤➤")
                               k6.sendMessage(msg.to, "۞❂✪₷ŚhÀH•ŹÀ!η❥₹ ⋮➲➤➤")
                               k7.sendMessage(msg.to, "۞❂✪₷ŚhÀH•ŹÀ!η❥₹ ⋮➲➤➤")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)
                                ki.sendMessage(msg.to, "Return "+str(G.name))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)
                                kk.sendMessage(msg.to, "Return "+str(G.name))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)
                                kc.sendMessage(msg.to, "Return "+str(G.name))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)
                                km.sendMessage(msg.to, "Return "+str(G.name))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)
                                kb.sendMessage(msg.to, "Return "+str(G.name))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)
                                sw.sendMessage(msg.to, "Return "+str(G.name))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)
                                dz.sendMessage(msg.to, "Return "+str(G.name))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in owner or msg._from in admin:
                                G = cl.getGroup(msg.to)
                                cl.sendMessage(msg.to, "Thanks for inviting\nsee you later... "+str(G.name))
...
#====================================================================                            
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                 ...
                                 cl.sendMessage(msg.to, "Lurking berhasil dinoactivekan\n\nTanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\nJam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                ...
                                if name not in images:
                                    ...
                                    cl.sendMessage(to, "Foto itu Already dalam list")
                               ...
                               if name in images:
                                   ...
                                   cl.sendMessage(to, "Foto itu not ada dalam list")
...
#==============add video==========================================================================
                                ...
                                if name not in images:
                                    ...
                                    cl.sendMessage(to, "video itu Already dalam list")
                               ...
                               if name in images:
                                   ...
                                   cl.sendMessage(to, "video itu not ada dalam list")
...
#=========== [ Add Audio] ============#
                                ...
                                if name not in audios:
                                    ...
                                    cl.sendMessage(to, "Mp3 itu Already dalam list") 
                                ...
                                if name in audios:
                                    ...
                                    cl.sendMessage(to, "Mp3 itu not ada dalam list") 
 ...
 #=========== [ Add sticker] ============#                   
                                ...
                                if name not in stickers:
                                    ...
                                    cl.sendMessage(to, "Sticker itu Already dalam list") 
                                ...
                                if name in stickers:
                                    ...
                                    cl.sendMessage(to, "Sticker itu not ada dalam list") 
          ...
          #                 if msg._from admin:
                          ...
                          if msg._from in admin:
                            ...
                            with requests.session() as s:
                                ...
                                try:
                                    ...
                                    cl.sendMessage(to, "Data cctv not ditemukan!")
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                                ...
                                num =  int(strnum)
                                wait["limit"] = num
                                cl.sendMessage(msg.to,"Total Spam Call Changed To " +strnum)
                           ...
                           if msg._from in admin:
                                if 'MENTION' in msg.contentMetadata.keys()!=None:
                                    ...
                                    if jmlh <= 1000:
                                        ...
                                        cl.sendMessage(msg.to,"The amount exceeds 1000")
                             ...
                             if msg.toType == 2:
                                ...
                                if jmlh <= 1000:
                                  for x in range(jmlh):
                                    ...
                                    cl.sendMessage(msg.to,"Total exceeded Limit")
                                            ...
                                            try:
                                                ...
                                                for i in grups:
                                                	...
                                                	if grup.name == namagrup:
                                                	    ...
                                                	    cl.sendText(to,"@! Success spam Group!\n\nvictim: @!\nTotal: {}\nnama Group: {}".format(Total, str(namaGroup)), [sender, tgb.mid])
                                            except Exception as e:
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                              victim = msg.text.replace('Gift: ','')
                              victim2 = victim.split()
                              midd = victim2[0]
                              Total = int(victim2[1])
                              if Total <= 1000:
                                  for var in range(0,Total):
                           ...
                           if msg._from in admin:
                              ...
                              if spl == 'on':
                                  if msg.to in protect["antijs"]:
                                       ...
                                       ginfo = cl.getGroup(msg.to)
                                       msgs = "Anti kicker \n\nactive di group : " +str(ginfo.name)
...
#===========ADMIN ADD============
                            ...
                            if msg._from in owner or msg._from in admin:
                               ...
                               for target in targets:
                                   if target not in Team:
                                       try:
                                           staff.append(target)
                                           cl.sendMessage(msg.to,"succєssfullч Add staff")
                                       except:
                                           pass
  ...
  #====================================#                                         
                            ...
                            if msg._from in owner:
                                ...
                                cl.sendMessage(to, "succєssfullч activate auto join")
                        elif cmd == "autojoin off":
                            if msg._from in owner:	
                                settings["autoJoin"] = False
                                cl.sendMessage(to, "succєssfullч deactivate auto join")
                        elif cmd == "autoblock on":
                           if msg._from in owner:
                                settings["autoBlock"] = True
                                cl.sendMessage(to, "succєssfullч activate auto Block")
                        elif cmd == "autoblock off":    
                            if msg._from in owner: 	
                                settings["autoBlock"] = False
                                cl.sendMessage(to, "succєssfullч deactivate auto Block")
                        elif cmd == "autoleave on":
                            if msg._from in owner:	
                                settings["autoLeave"] = True
                                cl.sendMessage(to, "succєssfullч activate auto leave")
                        elif cmd == "autoleave off":
                            if msg._from in owner:
                                settings["autoLeave"] = False
                                cl.sendMessage(to, "succєssfullч deactivate auto leave")
                        elif cmd == "autojointicket on":
                        	if msg._from in owner:
                                 settings["autoJoinTicket"] = True
                                 cl.sendMessage(to, "succєssfullч activate auto join by ticket")
                        elif cmd == "autojointicket off":
                           if msg._from in owner:
                                 settings["autoJoinTicket"] = False
                                 cl.sendMessage(to, "succєssfullч deactivate auto join by ticket")                        
                        elif cmd == "checkpost on":
                           if msg._from in owner:
                                 settings["checkPost"] = True
                                 cl.sendMessage(msg.to, "succєssfullч activate check details post")
                        elif cmd == "checkpost off":
                           if msg._from in owner:
                                settings["checkPost"] = False
                                cl.sendMessage(msg.to, "succєssfullч deactivate check details post")                                   
#==================================#
                            ...
                            if msg._from in admin:
                                settings["Spaminvite"] = False
                                cl.sendMessage(msg.to, "Send Contact to send Group Off..")
...
#===========COMMAND ON OFF============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in owner or msg._from in admin:
                                settings["autoJoinTicket"] = True
                                cl.sendMessage(msg.to,"Join ticket activated")
...
#===========COMMAND BLACKLIST============#
                               ...
                               for target in targets:
                                   if target not in Team:
                                       try:
                                           ...
                                           cl.sendMessage(msg.to,"succєssfullч Add blacklist")
                                       except:
                                           pass
                            ...
                            if msg._from in owner or msg._from in admin:
                               ...
                               for target in targets:
                                       try:
                                           ...
                                           cl.sendMessage(msg.to,"succєssfullч menghapus blacklist")
                                       except:
                                           pass
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in owner:
                              if wait["Talkblacklist"] == {}:
                                cl.sendMessage(msg.to,"not ada Talkban user")
                              else:
                                ma = ""
                                a = 0
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in owner:
                              if wait["blacklist"] == {}:
                                    cl.sendMessage(msg.to,"not ada blacklist")
                              else:
                                    ma = ""
                            ...
                            if msg._from in owner or msg._from in admin:
                               ...
                               cl.sendMessage(msg.to, "its for owner only")
#===========COMMAND SET============#
                           ...
                           if msg._from in admin:
                              ...
                              if spl in [""," ","\n",None]:
                                  cl.sendMessage(msg.to, "Failed to replace Pesan Msg")
                              else:
                                  wait["message"] = spl
                           ...
                           if msg._from in admin:
                              ...
                              if spl in [""," ","\n",None]:
                                  cl.sendMessage(msg.to, "Failed to replace Respon Msg")
                              else:
                                  wait["Respontag"] = spl
